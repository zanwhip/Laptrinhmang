...
async function loadLocalMedia(stream, kind) {
    ...
    switch (kind) {
        case 'video':
            ...
            myHandStatusIcon.style.setProperty('color', '#008080');
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our CLASSROOM Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=CLASSROOM info"> 
